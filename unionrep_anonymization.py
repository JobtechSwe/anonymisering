...
class unionrep_anonymize_swe(anonymize_swe):
    ...
    def initialize(self, **kwargs):
        names_m_extended = self._load_csv(self.currentdir + '/names/names_m_extended_minus_common_terms_2019.csv')
        names_f_extended = self._load_csv(self.currentdir + '/names/names_f_extended_minus_common_terms_2019.csv')

        firstnames = list(set(names_m_extended + names_f_extended))

        lastnames = self._load_csv(self.currentdir + '/names/lastnames_extended_minus_common_terms_2019.csv')
